...
#include "PortillonTest.h"

// Registers the fixture into the 'registry'
CPPUNIT_TEST_SUITE_REGISTRATION(PortillonTest);
...
int main(int argc, char* argv[])
{
    ...
    // for hudson
    std::ofstream file( "Portillon-cppunit-report.xml" );
